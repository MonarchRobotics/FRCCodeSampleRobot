...
public class Robot extends IterativeRobot {
    ...
    * */
    public static Drivetrain drivetrain = new Drivetrain(RobotMap.getFrontLeft(),
            RobotMap.getFrontRight(), RobotMap.getRearLeft(), RobotMap.getRearRight());
    public static OI oi;
    public static Gripper gripper = new Gripper(RobotMap.getLeftArmOfZanathyr(), RobotMap.getRightArmOfZanathyr());
    public static Lifter lifter = new Lifter(RobotMap.getForwardLifterChannel(), RobotMap.getReverseLifterChannel(),
